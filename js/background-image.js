	...
	$(function(){
		$.supersized({
			...
			slides					:	[			// Slideshow Images
					...
					{image : 'img/background/bg-4.jpg', title : '', thumb : '', url : ''},
					{image : 'img/background/bg-5.jpg', title : '', thumb : '', url : ''},
					{image : 'img/background/bg-6.jpg', title : '', thumb : '', url : ''},
					{image : 'img/background/bg-7.jpg', title : '', thumb : '', url : ''}
			]
		});
	});
})(jQuery);